...
main() {
  ...
  test("Must return the states in the right order, ignoring initial state", () {
    ...
    whenListen(searchBloc, Stream.fromIterable([LoadingState(<ResultSearchEntity>[]), SuccessState(result, "")]));
  ...
  test("Must return error", () {
    ...
    whenListen(searchBloc, Stream.fromIterable([LoadingState(<ResultSearchEntity>[]), ErrorState(error)]));
